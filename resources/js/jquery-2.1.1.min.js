...
! function() {
    $.fn.stepsForm = function(t) {
    	var registerUrl = $('#saveRegister').val()
        var e = {
                width: "100%",
                active: 0,
        ...
        return this.each(function() {
            ...
            f.css({
                ...
                requredcontrol = !1, f.find(".sf-steps-form>ul").eq(t.active).find(":input").each(function() {
                    ...
                    error: (function(t) {
                        console.log(t.responseJSON.response[0][0])
                        alert(t.responseJSON.response[0][0])
                    })
                })*/,null) : (t.active++, t.active > c - 1 ? (t.active--, f.find("#sf-msg").text("")) : (n(), requredcontrol = !1, f.find("#sf-msg").text(""))))
